...
remotes::install_github(repo = "steverozen/ICAMSxtra", ref = "0.0.5-branch")
```

Alternatively, you can download the [package
source](https://github.com/steverozen/ICAMSxtra/blob/master/data-raw/source-file/ICAMSxtra_0.0.5.tar.gz?raw=true)
...
<https://github.com/steverozen/ICAMSxtra/blob/master/data-raw/ICAMSxtra_0.0.5.pdf>
