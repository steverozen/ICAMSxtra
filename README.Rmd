...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/steverozen/ICAMSxtra.svg?branch=0.0.3-branch)](https://travis-ci.com/steverozen/ICAMSxtra)
<!-- badges: end -->
...
Alternatively, you can download the [package source](https://github.com/steverozen/ICAMSxtra/blob/0.0.3-branch/data-raw/source-file/ICAMSxtra_0.0.3.tar.gz?raw=true) file to your computer and install ICAMSxtra locally:
