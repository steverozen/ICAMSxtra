...
Alternatively, you can download the [package source](https://github.com/steverozen/ICAMSxtra/blob/master/data-raw/source-file/ICAMSxtra_0.0.4.9001.tar.gz?raw=true) file to your computer and install ICAMSxtra locally:
