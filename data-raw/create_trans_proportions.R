...
GRCh37.proportions$coding.bp <- Reduce("+", ICAMS::trans.ranges.GRCh37$end - ICAMS::trans.ranges.GRCh37$start + 1)

# size of the intergenic portion of genome
GRCh37.proportions$noncoding.bp <- total.bp - coding.bp

# proportion of genic portion of genome
GRCh37.proportions$prop.coding <- coding.bp / total.bp

# proportion of intergenic portion of genome
GRCh37.proportions$prop.noncoding <- noncoding.bp / total.bp
...
# size of the intergenic portion of genome
GRCh38.proportions$noncoding.bp <- total.bp - coding.bp

# proportion of genic portion of genome
GRCh38.proportions$prop.coding <- coding.bp / total.bp

# proportion of intergenic portion of genome
GRCh38.proportions$prop.noncoding <- noncoding.bp / total.bp
